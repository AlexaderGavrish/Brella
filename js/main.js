...
function map(n){
	...
	var locations = [
		[new google.maps.LatLng(49.8532495, 33.1597663)],
		[new google.maps.LatLng(48.0185967, 31.6670033)],
		[new google.maps.LatLng(48.4430569, 31.6724965, 7)],
		[new google.maps.LatLng(50.2535345, 30.7468983)],
	]
	var options = {
		zoom: 3,
		panControl:false,
